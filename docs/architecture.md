...
graph TD
    ...
    B --> B2["Generate - Генерация отчетов"]
    B --> B3["History - История операций"]
...
- **Generate** - Страница генерации отчетов на основе анализа
- **History** - Страница истории операций с возможностью повторного использования
...
#### 🌐 API слой (src/api)
- **Analysis API** - анализ CSV файлов с потоковой обработкой (NDJSON)
