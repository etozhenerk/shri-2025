...
| TC-HP-007 | Скриншот: состояние по умолчанию | Скриншотный (Страница) | **Высокая** | Фиксация базового вида страницы. |
| TC-HP-008 | Скриншот: состояние с результатами | Скриншотный (Страница) | **Высокая** | Фиксация вида страницы в ключевом успешном состоянии. |
| TC-HP-009 | Скриншот: состояние с ошибкой | Скриншотный (Страница) | **Средняя** | Фиксация вида страницы в состоянии ошибки. |
| **GeneratePage** |
...
| TC-GP-003 | Скриншот: состояние по умолчанию | Скриншотный (Страница) | **Высокая** | Фиксация базового вида страницы. |
| **HistoryPage** |
...
| TC-HY-008 | Скриншот: с заполненным списком | Скриншотный (Страница) | **Высокая** | Фиксация базового вида страницы с данными. |
| TC-HY-009 | Скриншот: модальное окно | Скриншотный (Страница) | **Высокая** | Фиксация вида ключевого элемента UI. |
| TC-HY-010 | Скриншот: пустая страница | Скриншотный (Страница) | **Средняя** | Фиксация вида "пустого" состояния. |
| **UI-Kit** |
| TC-UI-001 | Визуальные состояния компонентов | Визуальный (Компонент) | **Высокая** | Гарантирует, что все компоненты UI-кита (`кнопки`, `иконки`, `модальные окна` и т.д.) выглядят корректно во всех своих состояниях (default, disabled, hover и т.д.). | 